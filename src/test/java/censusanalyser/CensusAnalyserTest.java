...
public class CensusAnalyserTest {
    ...
    public void givenIndianStateCensusData_whenSortedByState_ShouldReturnTrue() {
        try {
            CensusAnalyser censusAnalyser = new CensusAnalyser();
            censusAnalyser.loadIndiaCensusData(INDIA_CENSUS_CSV_FILE_PATH);
            String sortedCensusData = censusAnalyser.sortByStateCensusData();
            IndiaCensusCSVDTO[] censusCSVS = new Gson().fromJson(sortedCensusData, IndiaCensusCSVDTO[].class);
    ...
    public void givenIndianStateCensusData_whenSortedByHighestPopulationState_ShouldReturnTrue() {
        try {
            CensusAnalyser censusAnalyser = new CensusAnalyser();
            censusAnalyser.loadIndiaCensusData(INDIA_CENSUS_CSV_FILE_PATH);
            String sortedCensusData = censusAnalyser.sortByPopulationCensusData();
            IndiaCensusCSVDTO[] censusCSVS = new Gson().fromJson(sortedCensusData, IndiaCensusCSVDTO[].class);
    ...
    public void givenIndianStateCensusData_whenSortedByHighestAreaInSqKm_ShouldReturnTrue() {
        try {
            CensusAnalyser censusAnalyser = new CensusAnalyser();
            censusAnalyser.loadIndiaCensusData(INDIA_CENSUS_CSV_FILE_PATH);
            String sortedCensusData = censusAnalyser.sortByAreaCensusData();
            IndiaCensusCSVDTO[] censusCSVS = new Gson().fromJson(sortedCensusData, IndiaCensusCSVDTO[].class);
    ...
    public void givenIndianStateCensusData_whenSortedByHighestDensity_ShouldReturnTrue() {
        try {
            CensusAnalyser censusAnalyser = new CensusAnalyser();
            censusAnalyser.loadIndiaCensusData(INDIA_CENSUS_CSV_FILE_PATH);
            String sortedCensusData = censusAnalyser.sortByDensityCensusData();
            IndiaCensusCSVDTO[] censusCSVS = new Gson().fromJson(sortedCensusData, IndiaCensusCSVDTO[].class);
    ...
    public void givenIndianStateCodeCSV_returnExactCount() {
        CensusAnalyser censusAnalyser = new CensusAnalyser();
        try {
            int noOfStateCodeResult = censusAnalyser.loadIndianStateCodeData(INDIA_STATE_CODE_FILE_PATH);
            Assert.assertEquals(37, noOfStateCodeResult);
        } catch (CensusAnalyserException e) {
        }
    }
}
